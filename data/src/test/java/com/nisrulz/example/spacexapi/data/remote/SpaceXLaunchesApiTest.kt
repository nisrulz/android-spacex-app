...
class SpaceXLaunchesApiTest {
    ...
    @Test
    fun `getAllLaunches() returns a list of LaunchInfoResponse on success`() =
        runUnconfinedTest {
            // Given
            setResponseForList()
    ...
    @Test
    fun `getAllLaunches() throws HttpException when service responds with 404 `() =
        runTest {
            // Given
    ...
    private fun setResponseForList() =
        apply {
            mockWebServer.setResponse(jsonForList)
        }

    private fun throwHttpExceptionForList() =
        apply {
            mockWebServer.throwHttpException(jsonForList)
        }

    private fun throwIOExceptionForList() =
        apply {
