...
import com.nisrulz.example.spacexapi.data.remote.dto.Fairings
import com.nisrulz.example.spacexapi.data.remote.dto.Flickr
import com.nisrulz.example.spacexapi.data.remote.dto.LaunchInfoResponse
import com.nisrulz.example.spacexapi.data.remote.dto.Links
import com.nisrulz.example.spacexapi.data.remote.dto.Patch
import com.nisrulz.example.spacexapi.data.remote.dto.Reddit
import com.nisrulz.example.spacexapi.domain.model.LaunchInfo

object TestFactory {
    //region LaunchInfoResponse
    private fun buildLaunchInfoResponse() =
        LaunchInfoResponse(
            auto_update = false,
            capsules = emptyList(),
            cores = emptyList(),
    ...
    fun buildListOfLaunchInfoResponse() =
        listOf(
    ...
    fun buildListOfLaunchInfoEntity() =
        listOf(
    ...
    fun buildListOfBookmarkedLaunchInfoEntity() =
        listOf(
            buildLaunchInfoEntity().copy(isBookmarked = true, id = "000001", name = "Flight 1"),
            buildLaunchInfoEntity().copy(isBookmarked = true, id = "000003", name = "Flight 3"),
        )
    ...
    fun buildListOfBookmarkedLaunchInfo() =
        listOf(
            buildLaunchInfo().copy(isBookmarked = true, id = "000001", name = "Flight 1"),
            buildLaunchInfo().copy(isBookmarked = true, id = "000003", name = "Flight 3"),
        )
